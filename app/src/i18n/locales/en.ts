export default {
  ...
  trips: {
    ...
    shareLinkOn: 'Anyone with the link can view',
    shareTurnOff: 'Stop sharing',
    shareCopy: 'Copy link',
    shareMessage: 'Check out my halal trip "{{name}}" on HalalNomad: {{url}}',
    shareOfflineTitle: 'Connect to share',
    shareOfflineMessage: 'Sharing creates a link on our servers, so it needs a connection. Reconnect and try again.',
    shareTitleBlockedTitle: 'Rename to share',
    shareTitleBlockedMessage: 'This trip name can’t be shared. Rename the trip, then share again.',
    shareCopied: 'Link copied',
    sharedTitle: 'Shared trip',
    sharedByName: 'Shared by {{name}}',
    sharedByAnon: 'Shared with you',
    sharedOfflineTitle: 'Reconnect to see this list',
    sharedOfflineSub: 'Shared trips need a connection to load.',
    sharedGoneTitle: 'This link isn’t available',
    sharedGoneSub: 'The trip may have been unshared, or the link is incorrect.',
    sharedFootNote: 'Shared read-only from HalalNomad — get the app to build your own.',
