export default {
  ...
  trips: {
    ...
    deleteWithCount_one: 'Delete “{{name}}” and its {{count}} saved place? This can’t be undone.',
    deleteWithCount_other: 'Delete “{{name}}” and its {{count}} saved places? This can’t be undone.',
    ...
    placeCount_zero: 'No places yet',
    placeCount_one: '{{count}} place',
    placeCount_other: '{{count}} places',
    defaultBadge: 'Default',
    comingSoon: 'Opening a trip to see its places is coming soon.',
    nameCounter: '{{count}}/{{max}}',
    // Save-to-a-trip (place detail)
    saveToTrip: 'Save to a trip',
    savedToTrip: 'Saved to trip',
    savedToast: 'Saved to {{name}}',
    alreadySaved: 'Already in your trip',
