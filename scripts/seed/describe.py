...
# GUARD: this module WRITES to the catalog when run. Everything that touches the
# DB stays under __main__ so `from describe import describe` (e.g. a scoped /
# NULL-only backfill) can reuse the pure helpers WITHOUT triggering a full
# catalog re-template on import (learned the hard way, 2026-08-29).
